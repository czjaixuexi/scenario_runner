...
class AvoidingObstaclesAndfollow(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._leading_vehicle_speed = 4

        self._leading_vehicle2_location = 45
        self._leading_vehicle2_speed = 6

        self._other_actor_max_brake = 1.0
        self._other_actor_stop_in_front_intersection = 1
        self._other_actor_transform = None

        super(AvoidingObstaclesAndfollow, self).__init__("AvoidingObstaclesAndfollow",
                                                        ego_vehicles,
                                                        config,
                                                        world,
                                                        debug_mode,
    ...
    def _create_behavior(self):
        ...
        driving_to_next_intersection.add_child(WaypointFollower(self.other_actors[2], self._leading_vehicle2_speed))
        driving_to_next_intersection.add_child(InTriggerDistanceToNextIntersection(self.other_actors[1], 10))
        driving_to_next_intersection.add_child(InTriggerDistanceToNextIntersection(self.other_actors[2], 60))

        # stop vehicle
        stop = StopVehicle(self.other_actors[1], self._other_actor_max_brake)
        stop = StopVehicle(self.other_actors[2], self._other_actor_max_brake)
